// Funnel section catalogue — data only.
// Kept JSX-free and import-free so the Node test runner can import this module directly
// (Node type stripping handles plain .ts, never .tsx).
